...
isAutoGenerated: true
        ...
        console.error("[YouTube] Error getting subtitles:", error);
        return null;
      }
    }
  }
...
u(
  ...
  function SettingsTab() {
    ...
    const handleScreenshotFilenameChange = async (filename) => {
      setScreenshotFilename(filename);
      await storage.set("module-screenshot-filename", filename);
      moduleSettings.value = {
        ...moduleSettings.value,
    ...
    const handleThumbnailDownloadToggle = async (enabled) => {
      setThumbnailDownload(enabled);
      await storage.set("module-thumbnail-download", enabled.toString());
      moduleSettings.value = {
        ...moduleSettings.value,
    ...
    const handleResetDefaults = async () => {
      ...
      await storage.set("module-thumbnail-download", "true");
...
u("div", { children: [
u("h3", { className: "text-xl font-semibold mb-4", children: "Reset to Default Settings" }),
u(
          "button",
          {
