...
(function (preact, signals, hooks, dayjs) {
  ...
  async function loadSettings() {
    ...
    if (savedTab === "insights" || savedTab === "livecount" || savedTab === "bookmark" || savedTab === "settings") {
  ...
  function InsightsTab() {
    ...
    const loadChannelInfo = async () => {
      if (activeTab.value !== "insights" || !isPanelVisible.value) {
        return;
      }
      if (isVideoPage()) {
...
u("span", { className: "text-xl font-semibold", children: tabs.reduce((sum, tab) => sum + tab.count, 0).toLocaleString() })
  ...
  function LiveCountTab() {
    ...
    const loadChannelData = async () => {
      if (activeTab.value !== "livecount" || !isPanelVisible.value) {
        if (intervalRef.current) {
          clearInterval(intervalRef.current);
          intervalRef.current = null;
        }
      ...
      if (isVideoPage()) {
        ...
        } else if (vId && !intervalRef.current && videoInfo) {
      ...
      if (id !== channelId) {
        ...
        isFetchingRef.current = false;
      } else if (id && !intervalRef.current && channelInfo) {
        startPolling(id);
      }
    };
    hooks.useEffect(() => {
    ...
    }, [channelId, videoId, activeTab.value, isPanelVisible.value]);
...
u("div", { className: "space-y-4", children: u(ThemeSelector, {}) })
      ] }),
u("div", { children: [
