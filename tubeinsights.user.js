...
u(
  ...
  function SettingsTab() {
    ...
    const handleResetDefaults = async () => {
      ...
      await storage.set("ddl-contentTab", "videos");
...
u("div", { className: "bg-base-200 rounded-lg p-4", children: [
u("label", { className: "text-xl font-medium mb-3 block", children: "DDL (Direct Download) Items Per Page" }),
u("div", { className: "join w-full", children: [
u(
                "input",
                {
...
`;
  ...
  async function captureScreenshot(player, actions) {
    ...
    const { screenshotFormat } = moduleSettings.value;
